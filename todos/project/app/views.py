...
def signup(request):
    if request.method == 'POST':
        firstame=request.POST.get('firstame')
        emailid=request.POST.get('emailid')
        pwd=request.POST.get('pwd')
        print(firstame,emailid,pwd)
        my_user=User.objects.create_user(firstame,emailid,pwd)
        my_user.save()
...
def loginn(request):
    if request.method == 'POST':
        ...
        pwd=request.POST.get('pwd')
        print(firstame,pwd)
        userr=authenticate(request,username=firstame,password=pwd)
